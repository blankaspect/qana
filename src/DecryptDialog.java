...
////////////////////////////////////////////////////////////////////////
    ...
    public static Result showDialog( Component parent,
                                     File      inFile )
    {
        return new DecryptDialog( GuiUtilities.getWindow( parent ), inFile ).getResult( );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    private void onChooseInputFile( )
    {
        ...
        if ( inputFileChooser.showDialog( this, SELECT_STR ) == JFileChooser.APPROVE_OPTION )
            inputFileField.setFile( Util.appendSuffix( inputFileChooser.getSelectedFile( ),
    ...
    private void onSetOutputFileFromInputFile( )
    {
        ...
        {
            File file = inputFileField.getFile( );
            outputFileField.setFile( Util.getPlaintextFile( file.getParentFile( ), file.getName( ) ) );
        }
    }
