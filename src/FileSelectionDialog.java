...
////////////////////////////////////////////////////////////////////////
    ...
    private static class FileSelectionPanel
        extends uk.org.blankaspect.gui.FileSelectionPanel
    {
    ...
    ////////////////////////////////////////////////////////////////////
                                               ...
                                               boolean      title )
        {
            ...
            return ( title ? StringUtilities.firstCharToUpperCase( str ) : str );
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private LengthField( int maxLength )
        {
            ...
            int numDigits = NumberUtilities.getNumDigitsDec( maxLength );
            String prototypeStr = PREFIX + EXCESS_PREFIX +
                                                StringUtilities.createCharString( '0', numDigits ) + SUFFIX;
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public void setLength( int length )
        {
            ...
            if ( !StringUtilities.equal( str, text ) )
            {
                text = str;
                repaint( );
            }
...
////////////////////////////////////////////////////////////////////////
    ...
    public static List<FileSelectionPanel.SelectedFile> showDialog( Component parent,
                                                                    ...
                                                                    int       maxNumFiles )
    {
        return new FileSelectionDialog( GuiUtilities.getWindow( parent ), titleStr, maxNumFiles ).
                                                                                                getFiles( );
    }
