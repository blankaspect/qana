...
////////////////////////////////////////////////////////////////////////
    ...
    public static Result showDialog( Component parent,
                                     boolean   inputFromFile )
    {
        return new ConcealDialog( GuiUtilities.getWindow( parent ), inputFromFile ).getResult( );
    }
    ...
    public void importFiles( File[] files )
    {
        if ( payloadFileField == null )
        {
            if ( carrierKind == CarrierKind.FILE )
                carrierFileField.setFile( files[0] );
            else
                outputFileField.setFile( files[0] );
        }
        else
            payloadFileField.setFile( files[0] );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    private void updateComponents( )
    {
        ...
        GuiUtilities.setAllEnabled( carrierFilePanel, file );
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( payloadFileField );
            throw e;
        }
        ...
        if ( carrierKind == CarrierKind.FILE )
        {
            ...
            {
                GuiUtilities.setFocus( carrierFileField );
                throw e;
            }
        }
