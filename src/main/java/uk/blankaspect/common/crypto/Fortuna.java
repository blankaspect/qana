...
Class: abstract base class of Fortuna pseudo-random number generator.
...
/**
 * This is the abtstract base class for implementations of the Fortuna pseudo-random number generator (PRNG) algorithm.
 * Subclasses are expected to provide a block cipher running in counter mode as the underlying generator.
 * <p>
 * The Fortuna PRNG is described in Niels Ferguson and Bruce Schneier, <i>Practical cryptography</i> (Wiley, 2003; ISBN
 * 0471223573).
 * </p>
 */
...
////////////////////////////////////////////////////////////////////////
	...
	/** The minumum number of bytes that the first entropy pool must contain to allow the PRNG to be reseeded. */
	public static final		int	RESEED_ENTROPY_THRESHOLD	= 64;

	/** The minimum interval (in milliseconds) between successive reseedings of the PRNG. */
...
////////////////////////////////////////////////////////////////////////
	...
	/**
	 * Creates a new instance of a Fortuna pseudo-random number generator that is initialised with a random seed derived
	 * from the sources
	 * of entropy.
	 *
	 * @param keySize
	...
	/**
	 * Creates a new instance of a Fortuna pseudo-random number generator that is initialised with the specified seed.
	 * <p>
	...
	/**
	 * Creates a new instance of a Fortuna pseudo-random number generator that is initialised with the specified seed in
...
////////////////////////////////////////////////////////////////////////
	 ...
	 * <p>
	 * The method is intended to be used for converting a key in the form of a string to a byte array for use as the
	...
	public static byte[] keyStringToBytes(
		String	key)
	{
...
////////////////////////////////////////////////////////////////////////
	 ...
	 * <p>
	 * This method is called by the constructors of this class to give subclasses the opportunity to initialise the
	 * cipher before the PRNG's key is set.
	 * </p>
	 */
...
////////////////////////////////////////////////////////////////////////
	 ...
	 *
	 * @param seed
	 *          an array of bytes that will be used to seed the pseudo-random number generator.  If {@code seed} is
	 *          {@code null}, a random seed derived from the sources of entropy will be used.
	 */
	 ...
	 * <p>
	 * The generator can be reseeded if the first entropy pool contains at least 64 bytes of entropy and at least 100
	 * milliseconds have elapsed since the generator was last reseeded.
	 * </p>
	 *
	...
	/**
	 * Generates and returns the specified number of random bytes, which are stored in a buffer that is allocated by
	 * this method.
	 *
	 * @param  length
	...
	/**
	 * Generates random bytes and stores them in the specified buffer.  The number of bytes generated is equal to the
	 * length of the buffer.
	 *
	 * @param  buffer
	 *           the buffer in which the random data will be stored.
	 * @throws IllegalArgumentException
	 *           if {@code buffer} is {@code null} or the length of {@code buffer} is greater than 2<sup>20</sup>
	 *           (1048576).
	 * @throws IllegalStateException
	 *           if the generator has not been seeded.
	 */
	 ...
	 *
	 * @param index
	 *          the index of the entropy pool to which the random data will be added.
	 * @param data
	 *          the random data that will be added to the specified entropy pool.
	 * @param offset
	 *          the offset of the start of the random data in {@code data}.
	 * @param length
	 *          the number of bytes of random data to add.
	 ...
	 *
	 * @param  blockSize
	 *           the number of bytes of random data that the combiner will extract from this PRNG with each request.
	 * @return an exclusive-OR combiner that uses this PRNG.
	 */

	public XorCombiner createCombiner(
		int	blockSize)
	{
...
////////////////////////////////////////////////////////////////////////
	...
	// CLASS: EXCLUSIVE-OR COMBINER


	/**
	 * This class implements a means of combining a stream of byte data and random data generated by a PRNG with an
	...
	////////////////////////////////////////////////////////////////////
		...
		/**
		 * Creates an object that will combine data and random data generated by the specified PRNG with an exclusive-OR
		 * operation.
		 *
		 * @param  prng
		 *           the pseudo-random number generator that will generate the random data for the exclusive-OR
		 *           operation.
		 * @param  blockSize
		 *           the number of bytes of random data that will be extracted from {@code prng} with each request.
		 * @throws IllegalArgumentException
	...
	////////////////////////////////////////////////////////////////////
		...
		/**
		 * Combines some specified data and random data generated by this object's PRNG with an exclusive-OR operation.
		 * <p>
		...
		/**
		 * Combines the specified number of bytes of data and random data generated by this object's PRNG with an
		 * exclusive-OR operation.
		 * <p>
		 * The exclusive-OR operation is applied to {@code data} in place.
		 * <p>
	...
	/**
	 * This class implements an entropy pool for the Fortuna PRNG.  It uses the double-iteration SHA-256 hash function
	 * (SHAd-256) to compress the stored entropy.  In the implementation of SHAd-256, the underlying SHA-256 hash
	 * function is provided by a {@link java.security.MessageDigest} object.  Depending on its implementation, the
	 * {@link MessageDigest} object may or may not be cloneable.  The {@code EntropyPool} class handles both
	 * possibilities in order to be cloneable itself: if the hash-function ({@link MessageDigest}) object is cloneable,
	 * the entropy is stored in the state of the hash-function object and extracted on demand; otherwise, whenever
	 * entropy is added to the pool, it is hashed with the existing entropy and immediately extracted from the
	 * hash-function object, which is less efficient.
	 */
	...
	////////////////////////////////////////////////////////////////////
		...
		/**
		 * Creates and returns a copy of this entropy pool.
		 *
	...
	////////////////////////////////////////////////////////////////////
		 ...
		 *
		 * @param data
		 *          the random data that will be added to the entropy pool.
		 * @param offset
		 *          the offset of the start of the random data in {@code data}.
		 * @param length
		 *          the number of bytes of random data to add.
