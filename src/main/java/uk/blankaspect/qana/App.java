...
////////////////////////////////////////////////////////////////////////
	...
	public void addImport(IFileImporter    fileImporter,
	...
	private void processFiles(List<File> files)
	{
		...
		for (int i = 0; i < files.size(); i++)
		{
			...
			catch (AppException e)
			{
				...
				{
					String[] optionStrs = Utils.getOptionStrings(AppConstants.CONTINUE_STR);
					if (JOptionPane.showOptionDialog(mainWindow, e, fileOp.titleStr, JOptionPane.OK_CANCEL_OPTION,
	...
	{
		processFiles((List<File>)AppCommand.IMPORT_FILES.getValue(AppCommand.Property.FILES));
	}
