...
import uk.blankaspect.ui.swing.checkbox.FixedWidthCheckBox;

import uk.blankaspect.ui.swing.combobox.BooleanComboBox;
import uk.blankaspect.ui.swing.combobox.FComboBox;

import uk.blankaspect.ui.swing.container.BitSelectionPanel;
...
////////////////////////////////////////////////////////////////////////
	...
	public void actionPerformed(ActionEvent event)
	{
		try
		{
			...
			{
				case Command.TOGGLE_ARCHIVE_VIEW_COLUMN                   -> onToggleArchiveViewColumn();
				case Command.SET_ARCHIVE_VIEW_COLUMN_WIDTHS_TO_CURRENT    -> onSetArchiveViewColumnWidthsToCurrent();
				case Command.CHOOSE_STATUS_TEXT_COLOUR                    -> onChooseStatusTextColour();
				case Command.CHOOSE_TEXT_VIEW_TEXT_COLOUR                 -> onChooseTextViewTextColour();
				case Command.CHOOSE_TEXT_VIEW_BACKGROUND_COLOUR           -> onChooseTextViewBackgroundColour();
				case Command.CHOOSE_TEXT_VIEW_SELECTION_TEXT_COLOUR       -> onChooseTextViewSelectionTextColour();
				case Command.CHOOSE_TEXT_VIEW_SELECTION_BACKGROUND_COLOUR ->
						onChooseTextViewSelectionBackgroundColour();
				case Command.CHOOSE_KEY_DATABASE                          -> onChooseKeyDatabase();
				case Command.CHOOSE_SEED_FILE_DIRECTORY                   -> onChooseSeedFileDirectory();
...
////////////////////////////////////////////////////////////////////////
	...
	private void onChooseKeyDatabase()
	{
		if (keyDatabaseFileChooser == null)
		{
			...
			FileChooserUtils.setFilter(keyDatabaseFileChooser, AppConstants.KEY_FILE_FILTER);
		}
	...
	private JPanel createPanelTextView()
	{
		...
		textViewSelectionTextColourButton.setActionCommand(Command.CHOOSE_TEXT_VIEW_SELECTION_TEXT_COLOUR);
		...
		textViewSelectionBackgroundColourButton = new ColourButton(config.getTextViewSelectionBackgroundColour());
		textViewSelectionBackgroundColourButton.setActionCommand(Command.CHOOSE_TEXT_VIEW_SELECTION_BACKGROUND_COLOUR);
	...
	private JPanel createPanelText()
	{
		...
		textWrapEndOfSentencePatternField =
				new FTextField(config.getTextWrapEndOfSentencePattern(), END_OF_SENTENCE_PATTERN_FIELD_NUM_COLUMNS);
	...
	private JPanel createPanelFiles()
	{
		...
		for (ActionSource actionSource : ActionSource.values())
		{
			...
			BooleanComboBox comboBox = new BooleanComboBox(actionSource.isSelectEncryptDecryptOutputFile());
		...
		fileErasureNumPassesSpinner =
				new FIntegerSpinner(config.getFileErasureNumPasses(), FileEraser.MIN_NUM_PASSES,
									FileEraser.MAX_NUM_PASSES, FILE_ERASURE_NUM_PASSES_FIELD_LENGTH);
	...
	private JPanel createPanelEntropy()
	{
		...
		entropyTimerDivisorSpinner =
				new FIntegerSpinner(config.getEntropyTimerDivisor(), EntropyAccumulator.MIN_TIMER_DIVISOR,
									EntropyAccumulator.MAX_TIMER_DIVISOR, ENTROPY_TIMER_DIVISOR_FIELD_LENGTH);
		...
		WindowUtils.addRunOnAddedToWindow(outerPanel, EntropyPanelLabel::update);
	...
	private void setPreferencesFiles()
	{
		...
		{
			config.setSelectEncryptDecryptOutputFile(
				key,
				selectEncryptDecryptOutputFileComboBoxes.get(key).getSelectedValue()
			);
		}
