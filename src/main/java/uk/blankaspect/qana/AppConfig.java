...
////////////////////////////////////////////////////////////////////////
	...
	private static final	String	PROPERTIES_FILENAME	= QanaApp.NAME_KEY + "-properties"
															+ AppConstants.XML_FILENAME_EXTENSION;
	private static final	String	FILENAME_STEM		= QanaApp.NAME_KEY + "-config";
	...
	private interface Key
	{
		...
		String	CONFIGURATION							= QanaApp.NAME_KEY + "Configuration";
...
////////////////////////////////////////////////////////////////////////
	...
	{
		QanaApp.INSTANCE.showWarningMessage(QanaApp.SHORT_NAME + " : " + CONFIGURATION_ERROR_STR, exception);
	}
	...
	{
		QanaApp.INSTANCE.showErrorMessage(QanaApp.SHORT_NAME + " : " + CONFIGURATION_ERROR_STR, exception);
	}
...
////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
		...
		("The version of the configuration file (%1) is not supported by this version of " + QanaApp.SHORT_NAME + "."),
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	...
	{
		return new File(PathnameUtils.parsePathname(getFileSelectionPathname(key)));
	}
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	...
	////////////////////////////////////////////////////////////////////
		...
		private static final	String	DEFAULT_FILENAME	= QanaApp.NAME_KEY + AppConstants.KEY_FILENAME_EXTENSION;
