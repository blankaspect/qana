...
////////////////////////////////////////////////////////////////////////
        ...
        public void run( )
        {
            ...
            try
            {
                key.getFileEncrypter( cipher, App.getEncryptionHeader( ) ).
                            encrypt( inFile, outFile, key.getKey( ), App.getInstance( ).getRandomKey( ) );
            }
            catch ( TaskCancelledException e )
            {
                // ignore
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public void run( )
        {
            ...
            try
            {
                App.getInstance( ).concealFile( inFile, carrierFile, outFile, maxNumBits, setTimestamp,
                                                addRandomBits, key );
            }
            catch ( TaskCancelledException e )
            {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public void run( )
        {
            ...
            try
            {
                App.getInstance( ).recoverFile( inFile, outFile, key );
            }
            catch ( TaskCancelledException e )
            {
                // ignore
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public void run( )
        {
            ...
            try
            {
                new FileSplitter( ).split( inFile, outDirectory, filePartLengthLowerLimit,
                                           filePartLengthUpperLimit, key );
            }
            catch ( TaskCancelledException e )
            {
                // ignore
