...
import uk.org.blankaspect.gui.FRadioButton;
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private TimeField( )
        {
            ...
            String prototypeStr = StringUtilities.createCharString( '0', NUM_DIGITS );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private static  byte[]  salt    = App.getInstance( ).getRandomBytes( KeyList.SALT_SIZE );
...
////////////////////////////////////////////////////////////////////////
                              ...
                              Map<KdfUse, StreamEncrypter.KdfParams> paramMap )
    {
        ...
        GuiUtilities.setPaddedLineBorder( kdfUsePanel, 2, 6, PANEL_BORDER_COLOUR );
        ...
        GuiUtilities.setPaddedLineBorder( paramPanel, PANEL_BORDER_COLOUR );
        ...
        GuiUtilities.setPaddedLineBorder( testPanel, PANEL_BORDER_COLOUR );
