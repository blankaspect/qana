...
import uk.org.blankaspect.gui.EditableComboBox;
...
import uk.org.blankaspect.util.IntegerPair;
...
////////////////////////////////////////////////////////////////////////
    ...
    private static class IndentField
        ...
        implements EditableComboBox.Editor
    {
    ...
    ////////////////////////////////////////////////////////////////////
    //  Instance methods : EditableComboBox.Editor interface
    ////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private HelpDialog( )
        {
            ...
            if ( helpDialogLocation == null )
                helpDialogLocation = GuiUtilities.getComponentLocation( this, TextWrapDialog.this );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static Result showDialog( Component parent,
                                     int       currentIndent )
    {
        return new TextWrapDialog( GuiUtilities.getWindow( parent ), currentIndent ).getResult( );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    private void updateComponents( )
    {
        ...
        if ( indentComboBox.isEnabled( ) )
            GuiUtilities.setFocus( indentComboBox );
    }
        ...
        throws AppException
    {
        ...
        if ( lineLength > 0 )
        {
            ...
            {
                GuiUtilities.setFocus( lineLengthComboBox );
                throw e;
            }
        }
...
////////////////////////////////////////////////////////////////////////
    ...
    static
    {
        Integer length = AppConfig.getInstance( ).getTextWrapDefaultLineLength( );
        if ( length != null )
        {
