...
import uk.org.blankaspect.util.ProgressListener;
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            TextDocument document = App.getInstance( ).getTextDocument( );
            if ( document != null )
...
////////////////////////////////////////////////////////////////////////
    ...
    public void updateCommands( )
    {
        ...
        boolean isTextOnClipboard = Util.clipboardHasText( );
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        ...
        // Display text
        setText( AppConfig.getInstance( ).isWrapCiphertextInXml( )
                                                        ? wrapTextInXml( ciphertext, Util.getCipher( key ) )
                                                        : ciphertext,
                 true );
    }
        ...
        throws AppException
    {
        ...
        if ( AppConfig.getInstance( ).isWrapCiphertextInXml( ) )
        {
            ...
            org.w3c.dom.Document document = XmlUtilities.createDocument( text );
        ...
        throws AppException
    {
        ...
        new FileConcealer( ).recover( inFile, outStream, App.getInstance( ).getLengthDecoder( ) );
                             ...
                             int     indent2 )
    {
        ...
        {
            int numSpaces = AppConfig.getInstance( ).getTextWrapNumSpacesBetweenSentences( );
            String replacementStr = "$1" + StringUtilities.createCharString( ' ', numSpaces );
        ...
        // Format paragraphs
        char[] indentChars = StringUtilities.createCharArray( ' ', Math.max( indent1, indent2 ) );
        ...
        throws AppException
    {
        ...
        ByteArrayOutputStream outStream = new ByteArrayOutputStream( );
        StreamEncrypter encrypter = key.getStreamEncrypter( Util.getCipher( key ) );
        ...
        encrypter.encrypt( inStream, outStream, data.length, new ModernCalendar( ).getTimeInMillis( ),
                           key.getKey( ), App.getInstance( ).getRandomKey( ) );
        ...
        throws AppException
    {
        ...
        try
        {
            ...
            String patternStr = AppConfig.getInstance( ).getTextWrapEndOfSentencePattern( );
    ...
    private void onPasteAll( )
        throws AppException
    {
        setText( Util.getClipboardText( ), false );
    }
