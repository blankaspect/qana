...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private static final    int K_LIMIT     = 1 << K_EXPONENT;

        private static final    int M_EXPONENT  = 20;
        private static final    int M_LIMIT     = 1 << M_EXPONENT;

        private static final    String  K_SUFFIX    = " KiB";
        private static final    String  M_SUFFIX    = " MiB";

        private static final    String  DEFAULT_LIMIT_SEPARATOR = "to";
        private static final    char[]  LIMIT_SEPARATOR_CHARS   =
        {
            '\u2013',   // EN DASH
            '\u2212'    // MINUS SIGN
        };
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            lowerLimit = 1 << exponent;
            upperLimit = 1 << (exponent + EXPONENT_INCREMENT);
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private static String limitToString( int limit )
        {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            return ( limitToString( lowerLimit ) + " " + LIMIT_SEPARATOR + " " +
                                                                            limitToString( upperLimit ) );
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        static
        {
            String separator = DEFAULT_LIMIT_SEPARATOR;
            for ( char separatorChar : LIMIT_SEPARATOR_CHARS )
            {
...
////////////////////////////////////////////////////////////////////////
    ...
    public static Result showDialog( Component parent,
                                     boolean   canGenerateText )
    {
        return new GarbageGeneratorDialog( GuiUtilities.getWindow( parent ), canGenerateText ).getResult( );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        GuiUtilities.setAllEnabled( outPathnamePanel, (outputKind == OutputKind.FILE) );
        GuiUtilities.setAllEnabled( imagePathnamePanel, (outputKind == OutputKind.IMAGE) );
        ...
        throws AppException
    {
        ...
        if ( outputKind == OutputKind.FILE )
        {
            ...
            {
                GuiUtilities.setFocus( outPathnameField );
                throw e;
            }
        }
        ...
        if ( outputKind == OutputKind.IMAGE )
        {
            ...
            {
                GuiUtilities.setFocus( imagePathnameField );
                throw e;
            }
        }
        ...
        {
            GuiUtilities.setFocus( lengthField );
            throw e;
        }
    }
    ...
    private void onChooseOutputFile( )
    {
        ...
        if ( outFileChooser.showDialog( this, SELECT_STR ) == JFileChooser.APPROVE_OPTION )
            outPathnameField.setFile( Util.appendSuffix( outFileChooser.getSelectedFile( ),
    ...
    private void onChooseImageFile( )
    {
        ...
        if ( imageFileChooser.showDialog( this, SELECT_STR ) == JFileChooser.APPROVE_OPTION )
            imagePathnameField.setFile( Util.appendSuffix( imageFileChooser.getSelectedFile( ),
                                                           AppConstants.PNG_FILE_SUFFIX ) );
    }
    ...
    private void onGenerateLength( )
    {
        ...
        int length = lengthRange.lowerLimit +
                                        randSeq.nextInt( lengthRange.upperLimit - lengthRange.lowerLimit );
...
////////////////////////////////////////////////////////////////////////
    ...
    static
    {
        ...
        LENGTH_RANGES.get( 0 ).lowerLimit = 1;
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    private PathnameField           outPathnameField;
    private PathnamePanel           outPathnamePanel;
    private PathnameField           imagePathnameField;
