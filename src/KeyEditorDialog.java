...
////////////////////////////////////////////////////////////////////////
                             ...
                             List<KeyList.Key> keys )
    {
        ...
        preferredCipherField = new ParameterField( TextUtilities.
...
////////////////////////////////////////////////////////////////////////
    ...
    public static KeyEditorDialog showDialog( Component         parent,
                                              List<KeyList.Key> keys )
    {
        return new KeyEditorDialog( GuiUtilities.getWindow( parent ), keys );
    }
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        ...
        if ( !name.isEmpty( ) && (index >= 0) )
        {
            ...
            String messageStr = StringUtilities.substitute( RENAME_MESSAGE_STR, name );
            String[] optionStrs = Util.getOptionStrings( RENAME_STR );
