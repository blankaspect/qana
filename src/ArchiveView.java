...
////////////////////////////////////////////////////////////////////////
        ...
        public void mouseClicked( MouseEvent event )
        {
            if ( SwingUtilities.isLeftMouseButton( event ) && (event.getComponent( ) == getTableHeader( )) )
            {
                ...
                if ( index >= 0 )
                {
                    ...
                    App.getInstance( ).getArchiveDocument( ).setSortingOrder( id, direction );
                }
            }
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            MainWindow window = App.getInstance( ).getMainWindow( );
        ...
        public void invertSelection( )
        {
            ...
            if ( !ranges.isEmpty( ) )
            {
                ...
                for ( IntegerRange range : ranges )
                    selectionModel.addSelectionInterval( range.lowerLimit, range.upperLimit - 1 );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        protected void paintComponent( Graphics gr )
        {
            ...
            TextUtilities.RemovalMode removalMode = (id.alignment == SwingConstants.TRAILING)
                                                                        ? TextUtilities.RemovalMode.START
                                                                        : TextUtilities.RemovalMode.END;
            String str = TextUtilities.getLimitedWidthString( id.text, fontMetrics,
            ...
            gr.drawString( str, x, GuiUtilities.getBaselineOffset( height, fontMetrics ) );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        protected void paintComponent( Graphics gr )
        {
            ...
            if ( (text != null) && !text.isEmpty( ) )
            {
                ...
                // Get limited-width text and x coordinate
                FontMetrics fontMetrics = gr.getFontMetrics( );
                TextUtilities.RemovalMode removalMode = (alignment == SwingConstants.TRAILING)
                                                                        ? TextUtilities.RemovalMode.START
                                                                        : TextUtilities.RemovalMode.END;
                String str = TextUtilities.getLimitedWidthString( text, fontMetrics,
                                                                  width - 2 * CELL_HORIZONTAL_MARGIN,
                                                                  removalMode );
    ...
    private static class ArchiveDirectoryPanel
        extends JComponent
        implements ActionListener, FileImporter, MouseListener
    {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private ArchiveDirectoryPanel( File directory )
        {
            ...
            if ( directory != null )
                pathname = Util.getPathname( directory );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            App.getInstance( ).setArchiveDirectory( files[0] );
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        protected void paintComponent( Graphics gr )
        {
            ...
            if ( pathname != null )
            {
                ...
                String str = TextUtilities.getLimitedWidthPathname( pathname, fontMetrics,
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            if ( !StringUtilities.equal( this.pathname, pathname ) )
            {
        ...
        private void onPaste( )
        {
            try
            {
                File[] files = DataImporter.
                                        getFiles( getToolkit( ).getSystemClipboard( ).getContents( null ) );
                if ( files != null )
                    importFiles( files );
            }
            catch ( Exception e )
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        archiveDirectoryPanel.setPathname( Util.getPathname( directory ) );
    }
