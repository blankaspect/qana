...
////////////////////////////////////////////////////////////////////////
    ...
    private static final    String  TITLE_STR                   = "Encrypt file";
    ...
    private static final    String  INPUT_FILE_TITLE_STR        = ENCRYPT_STR + " | Input file";
    private static final    String  OUTPUT_FILE_TITLE_STR       = ENCRYPT_STR + " | Output file";
...
////////////////////////////////////////////////////////////////////////
                           ...
                           File   inFile )
    {
        ...
        // Button: encrypt
        encryptButton = new FButton( ENCRYPT_STR );
        encryptButton.setActionCommand( Command.ACCEPT );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static Result showDialog( Component parent,
                                     File      inFile )
    {
        return new EncryptDialog( GuiUtilities.getWindow( parent ), inFile ).getResult( );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        encryptButton.setEnabled( !inputFileField.isEmpty( ) );
    }
    ...
    private void onChooseOutputFile( )
    {
        ...
        if ( outputFileChooser.showDialog( this, SELECT_STR ) == JFileChooser.APPROVE_OPTION )
            outputFileField.setFile( Util.appendSuffix( outputFileChooser.getSelectedFile( ),
