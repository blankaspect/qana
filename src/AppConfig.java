...
////////////////////////////////////////////////////////////////////////
    ...
    private interface Key
    {
        ...
        String  FILE                                    = "file";
        String  FILE_PART_LENGTH_LOWER_LIMIT            = "filePartLengthLowerLimit";
        String  FILE_PART_LENGTH_UPPER_LIMIT            = "filePartLengthUpperLimit";
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public String toString( )
        {
            return ( (value == null) ? new String( ) : value.width + ", " + value.height );
        }
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public String toString( ArchiveView.Column key )
        {
            ...
            return ( (value == 0) ? new String( ) : Integer.toString( value ) );
        }
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private CPKeyDatabasePathname( )
        {
            ...
            value = Util.getPathname( new File( Util.getPropertiesPathname( ), DEFAULT_FILENAME ), true );
        }
...
//--////////////////////////////////////////////////////////////////////
    ...
    public File getKeyDatabaseFile( )
    {
        ...
        return ( StringUtilities.isNullOrEmpty( pathname )
                                                ? null
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private CPSeedFileDirectoryPathname( )
        {
            ...
            value = Util.getPathname( new File( Util.getPropertiesPathname( ) ), true );
        }
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            return NumberUtilities.uIntToBinString( getValue( sourceKind ),
...
//--////////////////////////////////////////////////////////////////////
    ...
    // PROPERTY CLASS: SPLIT FILE-PART LENGTH LOWER LIMIT


    private class CPSplitFilePartLengthLowerLimit
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private CPSplitFilePartLengthLowerLimit( )
        {
            super( concatenateKeys( Key.SPLIT, Key.FILE_PART_LENGTH_LOWER_LIMIT ) );
...
//--////////////////////////////////////////////////////////////////////
    ...
    public ByteUnitIntegerSpinnerPanel.Value getSplitFilePartLengthLowerLimit( )
    {
        return cpSplitFilePartLengthLowerLimit.getValue( );
    }

    //------------------------------------------------------------------

    public void setSplitFilePartLengthLowerLimit( ByteUnitIntegerSpinnerPanel.Value value )
    {
        cpSplitFilePartLengthLowerLimit.setValue( value );
    }
...
//--////////////////////////////////////////////////////////////////////
    ...
    private CPSplitFilePartLengthLowerLimit cpSplitFilePartLengthLowerLimit =
                                                                    new CPSplitFilePartLengthLowerLimit( );

    //==================================================================


    // PROPERTY CLASS: SPLIT FILE-PART LENGTH UPPER LIMIT


    private class CPSplitFilePartLengthUpperLimit
        extends Property.SimpleProperty<ByteUnitIntegerSpinnerPanel.Value>
    {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private CPSplitFilePartLengthUpperLimit( )
        {
            super( concatenateKeys( Key.SPLIT, Key.FILE_PART_LENGTH_UPPER_LIMIT ) );
            value = new ByteUnitIntegerSpinnerPanel.Value( ByteUnitIntegerSpinnerPanel.Unit.MEBIBYTE,
                                                           64 << 20 );
        }
...
//--////////////////////////////////////////////////////////////////////
    ...
    public ByteUnitIntegerSpinnerPanel.Value getSplitFilePartLengthUpperLimit( )
    {
        return cpSplitFilePartLengthUpperLimit.getValue( );
    }

    //------------------------------------------------------------------

    public void setSplitFilePartLengthUpperLimit( ByteUnitIntegerSpinnerPanel.Value value )
    {
        cpSplitFilePartLengthUpperLimit.setValue( value );
    }
...
//--////////////////////////////////////////////////////////////////////
    ...
    private CPSplitFilePartLengthUpperLimit cpSplitFilePartLengthUpperLimit =
                                                                    new CPSplitFilePartLengthUpperLimit( );
