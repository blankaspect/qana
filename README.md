...
This repository contains the source code and resources of the Qana application.  The repo conforms to the Maven standard
...
* You may use the contents of the `uk.blankaspect.qana` package \(including resources\) under the terms and conditions
